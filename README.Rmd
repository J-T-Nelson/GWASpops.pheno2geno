...
TODO: Write tutorial and Vignettes, nest them into the github repo, link to them in this section. 

TODO: display a graph example image in this section to help give an early impression of what this package is capable of! 

##### Example Data

There is example data available in the "air_pollution" folder which has been used to generate the example plots below. New users may find this data helpful for learning the various functions in this package, as this data has been persistently used throughout package development and thus is guaranteed to play nicely with all package functions.  
